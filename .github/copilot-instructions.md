...
- do not wire pathless or repo-wide lint/build/test commands into automatic post-edit or stop hooks; keep them as manual full checks unless the repo declares a cheap file-scoped variant
